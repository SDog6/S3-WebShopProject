...
import project.classes.product_class.*;
...
import project.classes.product_classes.*;
import project.classes.product_classes.parent_class.*;
...
public class FakePartsData {
    ...
    public FakePartsData() {
        ...
        CPUCooling Cooler = new CPUCooling(new BasicProduct("CoolerMaster Hyper 212 Black Edition","Cooler Master",43.99,2),12);

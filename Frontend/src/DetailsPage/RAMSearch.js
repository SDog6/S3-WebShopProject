...
export class RAMSearch extends Component {
    ...
    <>
      <Card className="productPage">
        ...
        <tbody>
          ...
          <tr>
            <td colspan="1"> Amount: {this.state.Product.amount}</td>
          </tr>
          <tr>
            <td colspan="1"> Voltage: {this.state.Product.voltage}</td>
          </tr>
        </tbody>
      </Table>
